...
${ ctx.view === 'groups' ? `<div>
  <div class="card svelte-1wv06a5">
    <div>
      <img src="img/gnesta-turtles.png" style="max-height: 50px; max-width: 50px; border-radius: 50%;">
    </div>
    <div style="padding-left: 20px; margin-top: -2px; font-size: 16px;">
      Gnesta Turtles
    </div>
  ...
  <div class="card svelte-1wv06a5">
    <div>
      <img src="img/gubbar-som-cyklar.png" style="max-height: 50px; max-width: 50px; border-radius: 50%;">
    </div>
    <div style="padding-left: 20px; margin-top: -2px; font-size: 16px;">
      Gubbar som cyklar istället för bilar
    </div>
  </div>

  <div class="card svelte-1wv06a5">
    <div>
      <img src="img/na17a.png" style="max-height: 50px; max-width: 50px; border-radius: 50%;">
    </div>
    <div style="padding-left: 20px; margin-top: -2px; font-size: 16px;">
      NA17A ät veganskt
    </div>
